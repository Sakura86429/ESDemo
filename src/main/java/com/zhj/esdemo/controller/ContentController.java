...
//    public Boolean test(@PathVariable String keyword) throws IOException {
    public String test(@PathVariable String keyword) throws IOException {
        ...
        String[] myData = new String[] {"平板电视", "家庭影音", "对开门", "洗烘一体", "壁挂式空调", "立柜式空调", "烟灶", "热水器", "冰箱洗衣机",
...
//                "字典词典","工具书","经济","金融与投资","管理","励志与成功","杂志期刊","套装书","婴幼儿奶粉","孕妈奶粉","婴儿尿裤","拉拉裤","婴儿湿巾",
                ...
                "尤克里里","贝斯","提琴","古筝","月琴","胡琴","琵琶","萨克斯","二胡","双簧管","单簧管","爵士吉他","空灵鼓","沙锤","旅行小吉他","笛子",
                "箫","蝶骨","钟琴","面膜","爽肤水",
