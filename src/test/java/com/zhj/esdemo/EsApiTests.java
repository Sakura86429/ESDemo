...
public class EsApiTests {
    ...
    void createDocument() throws IOException {
        UserBean user = new UserBean().setId(1).setUsername("张三");
    ...
    void updateDocument() throws IOException {
        ...
        UserBean user = new UserBean().setUsername("李四");
    ...
    void createBulkDocument() throws IOException {
        ...
        list.add(new UserBean().setId(1).setUsername("张三"));
        list.add(new UserBean().setId(2).setUsername("李四"));
        list.add(new UserBean().setId(3).setUsername("王五"));
        list.add(new UserBean().setId(4).setUsername("赵六"));
